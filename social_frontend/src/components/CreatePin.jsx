...
import { MdDelete, MdDeleteIcon} from 'react-icons/md'
    ...
    return (
        <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
            ...
            <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
                ...
                <div className='flex flfex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
                    <input 
                        type="text"
                        value={title}
                    ...
                    {user && (
                        ...
                        <img src={user.image} alt="" className='w-10 h-10 rounded-full' alt="user image" />
                        ...
                        <div>
                            ...
                            >
                              ...
                              {categories.map((category,i)=>(
                                  <option className='text-base border-0 outline-none capitalize bg-white text-black' key={i} value={category.name}>{category.name}</option>
                              ))}
                            </select>
                        </div>
