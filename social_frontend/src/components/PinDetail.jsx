    ...
    return (
        ...
        <div className='flex xl:flex-row flex-col m-auto bg-white' style={{maxWidth: '1500px', borderRadius:'32px'}}>
            <div className='flex justify-center items-center md:items-start flex-initial'>
                <img alt="pin image" src={pinDetail?.image && urlFor(pinDetail.image).url()} className='rounded-t-3xl rounded-b-lg' />
            </div>
            <div className='w-full p-5 flex-1 xl:min-w-620'>
                ...
                <div>
                    ...
                    <p className='mt-3 italic'>Category: {pinDetail.category}</p>
                </div>
                ...
                <div className='flex flex-wrap mt-6 gap-3'>
                    <Link to={`user-profile/${user?._id}`} className=''>
                        <img
                            className='w-8 h-8 rounded-full object-cursor-pointer mt-2'
                            src={user?.image}
                            alt="user image"
                        />
                    </Link>
